...
const AddExperience = ({addExperience}) => {
    ...
    const [toDateDisabled,toggleDsabled]=useState(false);
    const {company ,title,location,from,to,currect,description}=formData;
  ...
  return (
    ...
    <p className="lead">
      <i className="fas fa-code-branch"></i> Add any Teaching experience you had in the past for any child
    </p>
    ...
    <form className="form" onSubmit={e=>{
      ...
      <div className="form-group">
        <input type="text" placeholder="* Company" name="company" value ={company} onChange={e=>onchange(e)} required required />
      </div>
      <div className="form-group">
